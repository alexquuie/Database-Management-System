...
void q2 (){
	...
	s.AddRel(relName[0],750000);
	s.AddAtt(relName[0], "o_custkey",50000);

	s.AddRel(relName[1],300000);
	s.AddAtt(relName[1], "c_custkey",150000);
	s.AddAtt(relName[1], "c_nationkey",25);
	
	s.AddRel(relName[2],50);
	s.AddAtt(relName[2], "n_nationkey",50);
...
void q5 (){
	...
	s.AddAtt(relName[1], "o_orderdate",3650);
...
void q7(){
	...
	s.AddAtt(relName[1], "l_receiptdate",3650);
